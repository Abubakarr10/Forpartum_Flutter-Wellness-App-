...
import 'package:forpartum/Dashboard/Post%20and%20Blog%20Pages/recentFeed.dart';
...
class MyFeedPostScreen extends StatefulWidget {
  const MyFeedPostScreen({super.key});

  @override
  State<MyFeedPostScreen> createState() => _MyFeedPostScreenState();
}

class _MyFeedPostScreenState extends State<MyFeedPostScreen> {
              ...
              children: [
                ...
                Padding(
                    ...
                    child: TextStyleHelper().mytext(
                        'My Feed Posts' , 20, FontWeight.w600, textColor)),
                InkWell(
                  onTap: (){
                ...
                children: [
                  ...
                  Expanded(
                    ...
                    child: Padding(
                      ...
                      child: CustomButton(title: "My Feed",
                  ...
                  Expanded(
                    ...
                    child: Padding(
                      ...
                      child: InkWell(
                        onTap: (){
                          Navigator.pushReplacement(context,
                             MaterialPageRoute(builder: (context)=>  const RecentPostScreen()));
                        },
                        child: CustomButton(title: "Recent", textColor: Colors.grey, backgroundColor: boxColor,
                          borderColor: Colors.grey,
                          height: 40, width: appWidth, textSize: 16,
                        ),
                      ),
