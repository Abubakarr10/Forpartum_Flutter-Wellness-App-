...
import 'Detail Pages/postDetailScreen.dart';
      ...
      floatingActionButton:selectedPage3 == true?  FloatingActionButton(
          ...
          onPressed: (){
            Navigator.push(context,
                MaterialPageRoute(builder: (context)=> const SubmitPost()));
          }) :
      Align(
            ...
            StreamBuilder<QuerySnapshot>(
              ...
              builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                  return  CircularProgressIndicator(color: textColor,); // Loading indicator while fetching data
                  ...
                  return Wrap(
                    children: posts.map((postDoc) {
                      ...
                      /// Likes subCollection Data
                      final likePostId = data['postId'];
                      final isLiked = followingStatus[likePostId] ?? false;
                      return InkWell(
                          onTap: (){
                            Navigator.push(context, MaterialPageRoute(
                                builder: (context)=> PostDetailsScreen(
                                    postChild: data['captions'] != ""? LimitedParagraph(
                                      text: data['captions'], maxLines: 50,) : const SizedBox(width: 1,),
                                    title: data['title'],
