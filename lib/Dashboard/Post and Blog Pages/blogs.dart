...
import 'package:forpartum/Dashboard/Post%20and%20Blog%20Pages/recentBlogs.dart';
...
class _BlogsScreenState extends State<BlogsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: selectedPage3 == true? SingleChildScrollView(
        child: Column(
          children: [
            /// ===== Top App Bar  ====
            Row(
                  ...
                  Expanded(
                    ...
                    child: Padding(
                      ...
                      child: InkWell(
                        onTap: (){
                            Navigator.pushReplacement(context,
                                MaterialPageRoute(builder: (context)=> const MyFeedPostScreen()));
                        },
                  ...
                  Expanded(
                    ...
                    child: Padding(
                      ...
                      child: InkWell(
                        onTap: (){
                          Navigator.pushReplacement(context,
                              MaterialPageRoute(builder: (context)=> const RecentBlogsScreen()));
                        },
