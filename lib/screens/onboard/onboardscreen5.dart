            ...
            Expanded(
                ...
                child: Column(
                  children: [
                    ...
                    TextStyleHelper().mytext('Discover personalized meal plans',
                        14, FontWeight.w400, Colors.black),
                    TextStyleHelper().mytext(
                        'designed to nourish your body during',
                        14,
                        FontWeight.w400,
                        Colors.black),
                    TextStyleHelper().mytext('the postpartum period.', 14,
                          ...
                          child: RoundButton(
                              ...
                              onClick: () {
                                ...
                                Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => const Onboardscreen6(),
                                    ));
                              },
                              height: 50,
                              width: MediaQuery.of(context).size.width,
